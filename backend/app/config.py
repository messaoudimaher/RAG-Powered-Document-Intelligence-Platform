...
class Settings(BaseSettings):
    ...
    chroma_collection_public: str = Field(default="public_index", validation_alias="CHROMA_COLLECTION_PUBLIC")
    chroma_collection_name: str = Field(default="papers_index", validation_alias="CHROMA_COLLECTION_NAME")
    ...
    # API configurations
    next_public_api_base_url: str = Field(default="http://localhost:8000", validation_alias="NEXT_PUBLIC_API_BASE_URL")
    ...
    enable_fallback_retrieval: bool = Field(default=True, validation_alias="ENABLE_FALLBACK_RETRIEVAL")
    arxiv_base_url: str = Field(default="http://export.arxiv.org/api", validation_alias="ARXIV_BASE_URL")
